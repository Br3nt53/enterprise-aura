...
from aura_v2.infrastructure.integrations.wms.schemas import fused_track_payload, alert_payload
from aura_v2.infrastructure.integrations.wms.client import WMSClient

@pytest.mark.asyncio
async def test_wms_payload_and_client(monkeypatch):
    t = {"id":"A1","bbox":[0,0,10,10],"score":0.9,"meta":{},"ts":datetime.utcnow().isoformat()}
